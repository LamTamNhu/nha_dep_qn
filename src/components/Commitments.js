    ...
    return (
        <section className="py-12 md:py-16">
            <div className="relative w-full max-h-screen">
                ...
                <div
                    className="relative flex flex-col lg:flex-row items-center justify-center mx-auto gap-8 lg:gap-12 px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 py-4 gap-4 z-10 w-full max-w-3xl">
            ...
            `}
                            >
                                <h3 className="text-white font-semibold text-lg mb-4 h-14 flex items-center uppercase text-center">
                                    {item.title}
                                </h3>
