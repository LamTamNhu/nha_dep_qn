"use client";
import {ArrowUpRight, Eye, Goal, Paintbrush, HandCoins, HeartHandshake, ShieldCheck, Users} from "lucide-react";
...
export default function Home() {
    ...
    const nextSlide = () => {
        ...
        setCurrentTransitionIndex(Math.floor(Math.random() * slideTransitions.length));
    };
            ...
            >
                {slides.map((slide, index) => {
                    ...
                    return (
                        <div
                            key={slide.id}
                            className={`absolute inset-0 ${currentTransition(index, currentSlide)}`}
                        >
                            <div
            ...
            <div className="py-12 px-4">
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <h3 className="text-md font-semibold mb-2 text-gray-500 text-justify">
                        Công ty TNHH NHÀ ĐẸP QUẢNG NAM do KTS Nguyên Tương thành lập là đơn vị hàng đầu trong lĩnh vực
                        Thiết kế và Thi công Nội thất hiện nay với gần 10 năm kinh nghiệm thực chiến. Chúng tôi chuyên
                        thiết kế thi công trọn gói cho Nhà Phố, Nhà Vườn, Biệt Thực, Chung Cư, Văn Phòng, Nhà Hàng,...
                    </h3>
                </div>
            </div>
                        ...
                        {cardData.map((card) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    {React.cloneElement(card.icon, {className: `w-12 h-12 ${card.iconColorClass}`})}
                                </div>
            ...
            <div className="py-12 bg-gray-50 px-4">
                <div className="max-w-6xl mx-auto px-4">
                    ...
                    <h3 className="text-md font-semibold mb-2 text-gray-500 text-justify mb-12">
                        Chính những trăn trở ấy đã trở thành động lực để chúng tôi xây dựng một quy trình thi công CHẶT
                        CHẼ - MINH BẠCH - CHẤT LƯỢNG, đảm bảo mỗi ngôi nhà khi bàn giao không chỉ đạt chuẩn kỹ thuật, mà
                        còn mang đến sự an tâm tuyệt đối cho gia chủ.Trên hành trình hơn 10 năm thực chiến, đội ngũ đã
                        không ngừng nỗ lực, học hỏi và đúc kết kinh nghiệm để mang đến những giải pháp thiết kế và thi
                        công chất lượng – tối ưu – bền vững.
                    </h3>
